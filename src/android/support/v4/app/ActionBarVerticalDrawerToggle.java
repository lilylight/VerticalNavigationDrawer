...
import android.support.v4.widget.VerticalDrawerLayout;
 ...
 * {@link VerticalDrawerLayout} and the framework <code>ActionBar</code> to implement the recommended
 * design for navigation drawers.
 *
 * <p>To use <code>ActionBarVerticalDrawerToggle</code>, create one in your Activity and call through
 ...
 * has occurred.</p>
 *
 * <p><code>ActionBarVerticalDrawerToggle</code> can be used directly as a
 * {@link VerticalDrawerLayout.DrawerListener}, or if you are already providing your own listener,
 * call through to each of the listener methods from your own.</p>
 */
public class ActionBarVerticalDrawerToggle implements VerticalDrawerLayout.DrawerListener {
    ...
    private final VerticalDrawerLayout mDrawerLayout;
     ...
     *
     * <p>The given {@link Activity} will be linked to the specified {@link VerticalDrawerLayout}.
     ...
     *                                  for accessibility
     */
    public ActionBarVerticalDrawerToggle(Activity activity, VerticalDrawerLayout drawerLayout,
     ...
     * may have diverged in such a way that the ActionBarVerticalDrawerToggle was not notified.
    ...
    public void syncState() {
        ...
        if (mDrawerIndicatorEnabled) {
            mSetIndicatorInfo = IMPL.setActionBarUpIndicator(mSetIndicatorInfo, mActivity,
                    mSlider, mDrawerLayout.isDrawerOpen(mGravity) ?
        ...
        if (enable != mDrawerIndicatorEnabled) {
            if (enable) {
                mSetIndicatorInfo = IMPL.setActionBarUpIndicator(mSetIndicatorInfo,
                        mActivity, mSlider, mDrawerLayout.isDrawerOpen(mGravity) ?
                        mOpenDrawerContentDescRes : mCloseDrawerContentDescRes);
            } else {
                mSetIndicatorInfo = IMPL.setActionBarUpIndicator(mSetIndicatorInfo,
    ...
    /**
     * {@link VerticalDrawerLayout.DrawerListener} callback method. If you do not use your
     * ActionBarVerticalDrawerToggle instance directly as your DrawerLayout's listener, you should call
    ...
    /**
     * Gravity is valid only for TOP or BOTTOM. Defaults to TOP.
     * 
     * @param gravity
     */
